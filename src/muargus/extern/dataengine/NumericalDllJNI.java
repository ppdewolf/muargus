...
public class NumericalDllJNI {
  ...
  public final static native void Numerical_DoTargetedRecordSwap(long jarg1, Numerical jarg1_, String jarg2, String jarg3, String jarg4, int jarg5, double jarg6, int jarg7, int[] jarg8, int[] jarg9, int[] jarg10, int jarg11, int[] jarg12, int jarg13, int[] jarg14, int jarg15, int jarg16, int jarg17, int[] jarg18, int[] jarg19, int jarg20, int[] jarg21, String jarg22);
  ...
  public static void SwigDirector_IProgressListener2_UpdateProgress(IProgressListener2 jself, int perc) {
